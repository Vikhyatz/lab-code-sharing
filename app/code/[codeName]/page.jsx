                        ...
                        <div className="container px-5 pt-24 pb-10 mx-auto">
                            <div className="lg:w-1/2 md:w-2/3 mx-auto">
                                <form onSubmit={(e) => { e.preventDefault(); setModal(!modal); console.log(codeContent) }} className="flex flex-wrap -m-2">
                                    ...
                                    <div className="p-2 w-full">
                                        <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" disabled={modal && true} type="submit">Save Code</button>
                                    </div>
                                    <div className="p-2 w-full">
