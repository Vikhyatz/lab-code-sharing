            ...
            <section className="text-gray-400 bg-gray-900 body-font relative">
                ...
                <h1 className='text-center text-3xl text-white mb-[30px]'>Create New Code</h1>
                        <div className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full">
                                <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" disabled={modal && true} onClick={()=>{setModal(!modal); console.log(codeContent)}}>Create Code</button>
                            </div>
                        </div>
                    </div>
                </div>
