...
const Page = () => {
    ...
    return (
        <>
                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        ...
                        <form onSubmit={(e) => {e.preventDefault(); setModal(!modal);}} className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full">
                                <button className="flex mx-auto text-white bg-emerald-400 border-0 py-2 px-8 focus:outline-none hover:bg-emerald-600 rounded text-lg" disabled={modal && true} type='submit'>Create Code</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            {modal && <SaveCheck codeHeading={codeContent.codeHeading} code={codeContent.code} id={codeContent.id} setModal={setModal} state="creating" year='second' lang={lang}/>}
        </>
    )
}
